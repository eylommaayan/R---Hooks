...
באפליקציית React, העיבוד הראשוני הוא הפעם הראשונה שעץ הרכיבים מעובד ל-DOM. זה קורה כאשר היישום נטען לראשונה, או כאשר רכיב השורש מוצג לראשונה. זה ידוע גם בשם "הרכבת" הרכיבים.

עיבוד מחדש, לעומת זאת, מתרחש כאשר המצב או האביזרים של הרכיב משתנים, ויש לעדכן את הרכיב ב-DOM כדי לשקף את השינויים הללו. React משתמש ב-DOM וירטואלי כדי לייעל את תהליך עדכון ה-DOM בפועל, כך שיבוצעו רק השינויים הדרושים.

ישנן מספר דרכים שבהן תוכל להפעיל רינדור מחדש ברכיב React:

- על ידי שינוי מצב הרכיב או האביזרים. כאשר המצב או האביזרים של הרכיב משתנים, React תעבד מחדש את הרכיב כדי לשקף את השינויים הללו.

- כאשר רכיב האב מעבד מחדש, גם אם המצב או האביזרים של הרכיב לא השתנו.;
